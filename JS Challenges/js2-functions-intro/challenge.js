...
export const calculateAreaOfCircle = (radius) => {
  ...
  // On StackOverflow I also found the solution: area = Math.round(area * 1e2) / 1e2;
  // But I don't really understand it, so I came up with a solution that made sense to me and still works.
...
export const getStudentSummary = (score, name) => {
  ...
  } else return ("My apologies " + name + ", there's been an error in processing your grade.")
};
